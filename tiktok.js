...
async function tiktok(client, message){
    ...
    if(!args){
        await client.sendMessage(remoteJid, { text: stylizedChar(" ✨ Mr Marco dєv | Dark Shadow dєv said plz provide a tiktok link: Ex: tiktok https://vm.tiktok.com ✨")})
        return ;
    }
    ...
    try {
        ...
        +
                      ...
                      💬 *Comments:* ${comment}\n 
                      🔗 *Share:* ${share}\n\n 
                        ᴘᴏᴡᴇʀᴇᴅ ʙʏ  ✨ Mr Marco dєv | Dark Shadow dєv ! 😉`);
